...
- `instructions-projet-merruditkit.md` — le texte à coller **une seule fois, dans les paramètres du Project** (pas dans le chat). Une fois en place, il suffit de taper "merruditkit" dans un message pour déclencher le chargement des 3 documents ci-dessus. **Méthode recommandée.**
...
**Méthode recommandée — "merruditkit"**
...
3. Colle-y tout le contenu de `instructions-projet-merruditkit.md`. Ça ne se fait qu'une fois, à la création du Project.
4. Dans le chat, tape simplement : `merruditkit`
